...
function validateForm() {
  ...
  var rn = (document.forms["form"]["rollno"].value).split("/");
	document.forms["form"]["rollno"].value).split("/")=" ";
  if (rn.length != 3) {
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Arcane</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Roll no" class="form-control input-md" type="text" required>
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <input id="username" name="username" placeholder="Choose a username" class="form-control input-md" type="username" required style="<?php
if (isset($_GET['q7']))
...
<span href="#" data-target="#login" style="color:lightyellow">Organized by Team Arcance, Coimbatore Institute of Technology, Coimbatore<br><br></span></div>
<div class="col-md-2 box">
