...
>>  Each team consist a two students is must<br/>
>>  You have to complete the event on time.<br/>
>>  Do not Refresh the page or Open any New tab until the event is completed or If you do so, the game will be abandoned.
	    ...
	    <div class="grid">
			...
			<footer class="login__footer">
				...
				<p>
				<!--	<span class="icon icon--info">?</span><a href="indexs.html">Forgot Password</a>  -->
				</p>
			</footer>
			</form>
		</div>
